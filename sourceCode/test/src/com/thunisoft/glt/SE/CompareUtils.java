...
public class CompareUtils {
	...
	public static void main(String[] args) {
		...
		try {
			...
			// TODO这是myeclipse的自定义标签，表示未完成的任务。另外的还有FIXME，表示需要修改的代码，而XXX，表示虽然实现了功能，但是可能有待改进的地方
			// 可以在Windows->Perferences->Java->Compile->Task Tags中自定义这些标签。可以在task视图中查看这些标记的信息。
			logger.error(e.getMessage(), e);
		}
	}
