...
public class CompareUtils {
	...
	/**
	 * ��ȡ�ļ����ļ��е�ÿһ����String��ʽ��ΪList�е�һ��Ԫ�ط���
	 * 
	 * @param file
	 * @return
	...
	public static List<String> readFile2List(File file) {
		if (file == null || !file.exists()) {
			throw new NullPointerException("����Ϊ�ջ�����ָ����ļ������ڡ�");
		}
		try {
	...
	public static List<String> intersection(List<String> oldL, List<String> newL) {
		...
		for (Iterator<String> iter_old = oldL.iterator(); iter_old.hasNext();) {
			...
			for (Iterator<String> iter_new = newL.iterator(); iter_new
					.hasNext();) {
	...
	public static void main(String[] args) {
		File dir = FileUtils.getFile("C:", "Users", "gaolong", "Desktop",
				"temp");
		File oldF = FileUtils.getFile(dir, "old.sql");
		File newF = FileUtils.getFile(dir, "new.sql");

		// ������¾��Ƿ���
		// File newF = FileUtils.getFile(dir, "odl.sql");
		// File oldF = FileUtils.getFile(dir, "new.sql");
		...
		try {
			// ���������ļ�
			FileUtils.writeLines(FileUtils.getFile(dir, "moreThan.sql"), rs);
		} catch (IOException e) {
			// TODO����myeclipse���Զ����ǩ����ʾδ��ɵ���������Ļ���FIXME����ʾ��Ҫ�޸ĵĴ��룬��XXX����ʾ��Ȼʵ���˹��ܣ����ǿ����д��Ľ��ĵط�
			// ������Windows->Perferences->Java->Compile->Task Tags���Զ�����Щ��ǩ��������task��ͼ�в鿴��Щ��ǵ���Ϣ��
			logger.error(e.getMessage(), e);
		}
	}
