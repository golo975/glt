...
public class SearchUtils {
	...
	/**
	 * ����һ��ͨ��������glt20141212.txt��������������ʽ�����(result.txt)
	 * @throws IOException
	 */
	@Test
	...
	public void getMappingFile() throws IOException{
		...
		for(String original : list){
			...
			for(File f : mappingFiles){
				boolean isPackageRight = false;// �����Ƿ�ƥ��
...
//					}
				...
				// TODO ������Ҫ�ڼ���findedPk�� ���Ӧ�ð� hqk ��spk���ҵ���
...
//				throw new RuntimeException("����mapping�ļ�ʧ�ܣ�");
			}
